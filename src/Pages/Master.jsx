    ...
    <div className="container">
        ...
        <tbody>
          {certificados.map((certificado, index) => (
            <tr key={index}>
              ...
              <td>
                <img
                  src={certificado.ruta_foto}
                  alt="foto certificado"
                  className="fotoCertificado"
                />
              </td>
              <td>
                <button
                  className="btn btn-danger botonBorrar"
                  onClick={() =>
                    handleBorrarCertificado(certificado.certificado_id)
                  }
                >
                  Borrar
                </button>
                <button
                  ...
                  onClick={() =>
                    handleShowModalCertificadoEditar(
      ...
      <div>
        <button
          ...
          onClick={handleShowModalCreacionCertificado}
        >
          Agregar certificado
        </button>
      </div>
          ...
          {paginas.map((pagina, index) => (
            <tr key={index}>
              ...
              <td>
                <button
                  className="btn btn-danger botonBorrar"
                  onClick={() => handleBorrarPagina(pagina.pagina_id)}
                >
                  Borrar
                </button>
                <button
                  className="btn btn-danger"
                  onClick={() =>
                    handleShowModalPaginaEditar(pagina.nombre_pagina)
                  }
                >
                  Editar Página
                </button>
      ...
      <div>
        <button
          className="btn btn-primary"
          onClick={handleShowModalCreacionPagina}
        >
          Agregar página
        </button>
      </div>

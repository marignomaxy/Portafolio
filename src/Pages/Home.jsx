      ...
      <Container>
        ...
        <Row>
          ...
          <Col xl={6} md={12}>
            ...
            <p>¡Antes que nada, gracias por visitar mi página! Soy Maximiliano Marigno, vivo en La Plata, Argentina, y a mis 25 años, soy un apasionado desarrollador full stack y diseñador UX/UI. Mi objetivo es obtener un trabajo donde pueda aplicar mis habilidades y contribuir de manera significativa. ¡Explora más sobre mí, mi potencial y mi trayectoria en el mundo del desarrollo y diseño!</p>
            <Nav.Link as={Link} to="/about" onClick={() => handleEnlaceClick("about")} className={enlaceActivo === "about" ? "enlace-activo" : ""}><h4 className="colorH4">Conoce más sobre mí</h4></Nav.Link>
            <h4>Tecnologías y herramientas</h4>
            
            <div className="d-flex contenedorTec">
              <div className="row">
              <img src="https://s3.amazonaws.com/media-p.slid.es/uploads/40730/images/2781438/react.png" alt="React" className="img-fluid" />

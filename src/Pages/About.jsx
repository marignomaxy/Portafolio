            ...
            <Col xl={6} md={12} className="mt-5">
              <div className="colorAzul">
                ...
                <p>
                  ...
                  Maximiliano, tengo 25 años y soy un estudiante de Tecnicatura
                  Superior en Programación con un enfoque en el desarrollo Full
                  Stack. Soy de La Plata, Argentina, y mi pasión es dar vida a
                  través de la programación a proyectos que impacten de manera
            ...
            <Col xl={6} md={12} className="mt-5">
              <div className="colorAmarillo">
                ...
                <p>
                  ...
                  tecnologías como Angular, React JS, .NET, Java, Node.js y una
                  variedad de motores de bases de datos. Mi enfoque abarca desde
                  la creación de interfaces de usuario de alta calidad hasta el
                  diseño de infraestructura en AWS. Mi objetivo es transformar
                  la visión de las empresas en soluciones impactantes y
                  efectivas.
                </p>
              </div>
            </Col>
            <Col xl={6} md={12} className="mt-5">
              <div className="colorVerde">
                ...
                <p>
                  ...
                  destacado y dejar una huella positiva en la industria. Quiero
                  dominar diversas tecnologías y crear software innovador que
                  resuelva problemas reales. Además, busco contribuir
                  activamente a la comunidad de desarrollo y ayudar a otros a
                  crecer en su camino tecnológico. Mi ambición es ser reconocido

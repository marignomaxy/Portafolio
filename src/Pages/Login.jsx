    ...
    <div className="container">
      ...
      <Form onSubmit={handleSubmit(handleLogin)}>
        <Form.Group className="mb-3" controlId="formBasicEmail">
          ...
          <Form.Control type="email" placeholder="Ingrese Email" {...register('email', { required: true })} value={mail} onChange={(e) => setMail(e.target.value)} />
          <Form.Text className="text-muted">{errors.email && <span>El Campo Es Obligatorio</span>}</Form.Text>
        </Form.Group>

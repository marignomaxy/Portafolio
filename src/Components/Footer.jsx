  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-banner d-flex align-items-center justify-content-center flex-column">
        ...
        <div>
          <Button className={`botonFooterAct ${enlaceActivo === 'portafolio' ? 'enlace-activo' : ''}`} as={Link} to="/portafolio" onClick={() => handleEnlaceClick('portafolio')}>
            Mira mis proyectos
          </Button>
      ...
      <div className="d-flex justify-content-between align-items-center">
        <div>
          ...
          <div>
            <a href="https://www.linkedin.com/in/maximiliano-marigno-7b6772173/" target="_blank" rel="noreferrer">
              <img src={linkedin} alt="linkedin" className="footerImgContacto" />
            </a>
            <a href="https://wa.me/5492213644416?text=Hola%20me%20contacto%20por%20tu%20portafolio" target="_blank" rel="noreferrer">
              <img src={whats} alt="whatsapp" className="footerImgContacto" />
            </a>
            <a href="https://www.instagram.com/marignomaxy/" target="_blank" rel="noreferrer">
              <img src={insta} alt="instagram" className="footerImgContacto" />
            </a>
            <a href="https://m.facebook.com/maxy.marigno/" target="_blank" rel="noreferrer">
        ...
        <div>
          <div>
            <Container className="d-flex justify-content-between">
              <Row>
                <Col>
                  <Nav.Link as={Link} to="/" onClick={() => handleEnlaceClick('inicio')} className={` ${enlaceActivo === 'inicio' ? 'enlace-activo' : ''}`}>
                    Inicio
                  </Nav.Link>
                  <Nav.Link as={Link} to="/portafolio" onClick={() => handleEnlaceClick('portafolio')} className={` ${enlaceActivo === 'portafolio' ? 'enlace-activo' : ''}`}>
                    Portafolio
                  </Nav.Link>
                </Col>
                <Col>
                  ...
                  <Nav.Link as={Link} to="/contactame" onClick={() => handleEnlaceClick('contactame')} style={{ whiteSpace: 'nowrap' }}>
                    Trabajemos juntos
                  </Nav.Link>
                </Col>
              </Row>

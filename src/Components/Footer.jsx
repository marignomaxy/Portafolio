    ...
    <footer className="footer">
      {/* Banner que sobresale */}
        <div className="footer-banner d-flex align-items-center justify-content-center flex-column">
            ...
            <div>
                <Button className={`botonFooterAct ${enlaceActivo === "portafolio" ? "enlace-activo" : ""}`} as={Link} to="/portafolio" 
                ...
                <Container className="d-flex justify-content-between">
                    <Row>
                        ...
                        <Col>
                            ...
                            <Nav.Link as={Link} to="/" style={{ whiteSpace: 'nowrap' }}>Trabajemos juntos</Nav.Link>
                        </Col>
                    </Row>
                </Container>
